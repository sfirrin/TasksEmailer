...
def create_message(task_list):
    ...
    for task in task_list:
        ...
        message += "</li>\n"
    message += "\n</ul>\n"
    message += '''<a href="http://www.weatherforyou.com/weather/north+carolina/chapel+hill.html">\n<img src="http://www.weatherforyou.net/fcgi-bin/hw3/hw3.cgi?config=png&forecast=zone&alt=hwizone&place=chapel+hill&state=nc&country=us&hwvbg=&hwvtc=&hwvdisplay=&daysonly=2&maxdays=4" width="300" height="200" border="0" alt="Chapel Hill, North Carolina, weather forecast"></a>'''
    message+= "\n</body>"
    return message
